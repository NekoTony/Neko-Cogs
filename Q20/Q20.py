...
class Q20:
    ...
    async def play20(self, ctx, questions=None):
        ...
        await self.bot.send_message(author, "Well there bud, you got {} people joining your game. Now let me ask you, what is the answer people need to guess?".format(totalusers))
